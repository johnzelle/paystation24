...
class TestReceipt(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bcrec = Receipt(30, barcode=True)
    ...
    def test_sets_with_barcode_flag(self):
        self.assertFalse(self.stdrec.with_barcode)
        self.assertTrue(self.bcrec.with_barcode)
